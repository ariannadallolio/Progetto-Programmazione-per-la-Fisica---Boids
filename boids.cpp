...
// vettore positions (quello con tutti i boids). Si potrebbe dare in input alle 3
// funzioni delle velocità questo vettore così da non far scorrere tutte e 3 le
// volte tutti i boid per trovarne i vicini. Poi (nel main?) si può fare un
...
// dare in input, e metterci forse vettori positions, velocities, neighbours e i 3 metodi per le velocità?
class boid {
...
// forse anche una funzione che ogni volta mi trova i boid a distanza <d e per
// le 3 velocità mi usa nei calcoli solo quei boid senza dover scorrerli tutti
